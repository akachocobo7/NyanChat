...
function signIn() {
  // Sign into Firebase using popup auth & Twitter as the identity provider.
...
var catFormElement = document.getElementById('cat-form');
...
catFormElement.addEventListener('click', onCatButtonClick);
